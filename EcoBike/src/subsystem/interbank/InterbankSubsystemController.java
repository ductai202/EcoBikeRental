...
public class InterbankSubsystemController {
	...
	private static final String PUBLIC_KEY = "CnmcWWpJv3s=";
	private static final String SECRET_KEY = "BW+J8orExpI=";
	...
	public boolean reset() {
		String data = "{\r\n" + "    \"cardCode\": \"kscq2_group20_2021\",\r\n" + "    \"owner\": \"Group 20\",\r\n"
				+ "    \"cvvCode\": 698,\r\n" + "    \"dateExpired\": 1125\r\n" + "}";
		String responseText = interbankBoundary.query(Configs.RESET_URL, data);
		System.out.println("reset: " + responseText);
		MyMap response = null;
		return true;
	}
